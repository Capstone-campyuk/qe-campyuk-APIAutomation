...
public class RegisterUserStepDef {
    ...
    public void baseURLIs_AndInputJsonBody() {
        File json = new File(Constant.JSON_REQUEST + "/Auth/RegisterUser.json");
    ...
    @And("API should return body page")
    public void apiShouldReturnBodyPage() {
